...
export function withMiddleware<Args extends any[], R extends any, This = unknown>(
...
export function useBeforeMiddleware<Args extends any[], R extends any, This = unknown>(
  onBefore: (this: This, args: Args) => unknown,
...
export function useArgsMiddleware<Args extends any[], R extends any, This = unknown>(
  modify: (args: Args) => Args | void,
): Middleware<Args, R, This> {
  return (args, next) => {
...
export function useRetryMiddleware<Args extends any[], R extends Promise<any>, This = unknown>(opts: {
  times?: number;
  delay?: number;
