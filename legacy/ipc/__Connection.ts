...
import { IClient, IClientConnOpts, IClientEvents, IClientMessage } from "@interfaces/index";
...
export class Client<PostMsg extends IClientMessage = IClientMessage, ReceivedMsg extends IClientMessage = PostMsg>
